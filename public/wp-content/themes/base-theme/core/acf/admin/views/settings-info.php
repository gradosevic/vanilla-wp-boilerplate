...
<div class="wrap about-wrap acf-wrap">
	...
	<div
		class="about-text"><?php printf( __( "Thank you for updating! ACF %s is bigger and better than ever before. We hope you like it.", 'acf' ), $version ); ?></div>
	...
	<?php elseif ( $active == 'changelog' ): ?>
		...
		<ul class="changelog">
			<?php foreach ( $items as $item ):
				...
				?>
				<li><?php echo $item[0]; ?><?php if ( isset( $item[1] ) ): ?><a href="http<?php echo $item[1]; ?>"
