		...
		function render_field( $field ) {
			...
			<div <?php acf_esc_attr_e( $atts ); ?>>
				...
				<div class="title acf-soh">
					...
					<div class="has-value">
						<a href="#" data-name="clear-location" class="acf-icon acf-icon-cancel grey acf-soh-target"
						   title="<?php _e( "Clear location", 'acf' ); ?>"></a>
						<h4><?php echo $field['value']['address']; ?></h4>
					</div>

					<div class="no-value">
						<a href="#" data-name="find-location" class="acf-icon acf-icon-location grey acf-soh-target"
