	...
	class acf_field_flexible_content extends acf_field {
		...
		*/
		...
		function render_field( $field ) {
			...
			?>
			<div <?php acf_esc_attr_e( array( 'class'    => 'acf-flexible-content',
			                                  'data-min' => $field['min'],
			                                  'data-max' => $field['max']
			) ); ?>>
		...
		function render_layout( $field, $layout, $i, $value ) {
			...
			<div <?php acf_esc_attr_e( $layout_atts ); ?>>
				...
				<div style="display:none">
					<?php acf_hidden_input( array( 'name'  => "{$field['name']}[{$i}][acf_fc_layout]",
					                               'value' => $layout['name']
					) ); ?>
				</div>
				...
				<ul class="acf-fc-layout-controlls acf-hl acf-clearfix">
					<li>
						<a class="acf-icon acf-icon-plus small acf-fc-add" href="#" data-before="1"
						   title="<?php _e( 'Add layout', 'acf' ); ?>"></a>
					</li>
					<li>
						<a class="acf-icon acf-icon-minus small acf-fc-remove" href="#"
						   title="<?php _e( 'Remove layout', 'acf' ); ?>"></a>
					</li>
				</ul>
		...
		*/
		...
		function render_field_settings( $field ) {
			...
			foreach ( $field['layouts'] as $layout ) {
				...
				?>
				<tr class="acf-field" data-name="fc_layout" data-setting="flexible_content"
				    data-key="<?php echo $layout['key']; ?>">
				<td class="acf-label">
					<label><?php _e( "Layout", 'acf' ); ?></label>
					<p class="description acf-fl-actions">
						<a data-name="acf-fc-reorder"
						   title="<?php _e( "Reorder Layout", 'acf' ); ?>"><?php _e( "Reorder", 'acf' ); ?></a>
