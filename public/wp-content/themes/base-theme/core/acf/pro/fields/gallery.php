	...
	class acf_field_gallery extends acf_field {
		...
		*/
		...
		function __construct() {
			...
			add_action( 'wp_ajax_nopriv_acf/fields/gallery/update_attachment', array(
				$this,
		...
		*/
		...
		function render_attachment( $id = 0, $field ) {
			...
			<div class="acf-gallery-side-info acf-cf">
				...
				<p class="actions"><a href="#" class="edit-attachment"
				                      data-id="<?php echo $id; ?>"><?php _e( 'Edit', 'acf' ); ?></a> <a href="#"
				                                                                                        class="remove-attachment"
				                                                                                        data-id="<?php echo $id; ?>"><?php _e( 'Remove', 'acf' ); ?></a>
				</p>
			</div>
		...
		function render_field( $field ) {
			...
			<div <?php acf_esc_attr_e( $atts ); ?>>
				...
				<div class="acf-hidden">
					<input type="hidden" <?php acf_esc_attr_e( array(
						'name'      => $field['name'],
						'value'     => '',
						'data-name' => 'ids'
					) ); ?> />
				...
				<div class="acf-gallery-main">
							...
							<?php foreach ( $posts as $post ):
								...
								<div class="<?php echo $thumb_class; ?>" data-id="<?php echo $post->ID; ?>">
									...
									<div class="margin" title="<?php echo $filename; ?>">
										...
										<?php if ( $type !== 'image' ): ?>
											<div
												class="filename"><?php echo acf_get_truncated( $filename, 18 ); ?></div>
										<?php endif; ?>
									</div>
									<div class="actions acf-soh-target">
										<a class="acf-icon acf-icon-cancel dark remove-attachment"
										   data-id="<?php echo $post->ID; ?>" href="#"></a>
									</div>
								</div>
					...
					<div class="acf-gallery-toolbar">
						...
						<ul class="acf-hl">
							<li>
								<a href="#"
								   class="acf-button blue add-attachment"><?php _e( 'Add to gallery', 'acf' ); ?></a>
							</li>
							<li class="acf-fr">
