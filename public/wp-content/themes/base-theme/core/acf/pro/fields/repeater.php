			...
			<div <?php acf_esc_attr_e( array( 'class'    => 'acf-repeater',
				...
				<table <?php acf_esc_attr_e( array( 'class' => "acf-table acf-input-table {$field['layout']}-layout" ) ); ?>>
					...
					<?php foreach ( $field['value'] as $i => $row ): ?>
						<tr class="acf-row<?php echo ( $i === 'acfcloneindex' ) ? ' acf-clone' : ''; ?>">
							...
							<?php if ( $show_order ): ?>
								<td class="order"
								    title="<?php _e( 'Drag to reorder', 'acf' ); ?>"><?php echo intval( $i ) + 1; ?></td>
							<?php endif; ?>
							...
							<?php if ( $show_remove ): ?>
								<td class="remove">
									<a class="acf-icon acf-icon-plus small acf-repeater-add-row" href="#"
									   data-before="1" title="<?php _e( 'Add row', 'acf' ); ?>"></a>
									<a class="acf-icon acf-icon-minus small acf-repeater-remove-row" href="#"
									   title="<?php _e( 'Remove row', 'acf' ); ?>"></a>
								</td>
							<?php endif; ?>
				...
				<?php if ( $show_add ): ?>
					...
					<ul class="acf-hl acf-clearfix">
						<li class="acf-fr">
							<a href="#"
							   class="acf-button blue acf-repeater-add-row"><?php echo $field['button_label']; ?></a>
						</li>
					</ul>
