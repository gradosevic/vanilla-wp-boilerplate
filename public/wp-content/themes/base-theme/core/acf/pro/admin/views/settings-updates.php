...
<div class="wrap acf-settings-wrap">
	...
	<div class="acf-box">
		...
		<div class="inner">
			<p><?php _e( "To unlock updates, please enter your license key below. If you don't have a licence key, please see", 'acf' ); ?>
				<a href="http://www.advancedcustomfields.com/pro"
				   target="_blank"><?php _e( 'details & pricing', 'acf' ); ?></a></p>
				...
				<tr>
					...
					<td>
						<?php if ( $update_available ): ?>
							...
							<?php if ( $active ): ?>
								<a class="acf-button blue"
								   href="<?php echo admin_url( 'plugins.php?s=Advanced+Custom+Fields+Pro' ); ?>"><?php _e( 'Update Plugin', 'acf' ); ?></a>
							<?php else: ?>
								<a class="acf-button" disabled="disabled"
								   href="#"><?php _e( 'Please enter your license key above to unlock updates', 'acf' ); ?></a>
							<?php endif; ?>
						...
						<?php else: ?>
							...
							<a class="acf-button"
							   href="<?php echo add_query_arg( 'force-check', 1 ); ?>"><?php _e( 'Check Again', 'acf' ); ?></a>
						<?php endif; ?>
					</td>
				</tr>
				<?php if ( $changelog ): ?>
